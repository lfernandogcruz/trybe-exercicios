...
// O Curiosity envia para a Terra a temperatura atual em Marte, gastando um tempo variável
// de até 5 segundos para que termine o envio.
...
function sendMarsTemperature(temp, delay) {
  return setTimeout(() => {
